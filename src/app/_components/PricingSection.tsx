...
const features: PricingFeature[] = [
  { name: "Real-time collaboration rooms", included: "starter" },
  { name: "Up to 5 team members per room", included: "starter" },
  { name: "Basic AI bug detection", included: "starter" },
  { name: "Community support", included: "starter" },
  { name: "Advanced code analysis", included: "pro" },
  { name: "Unlimited room members", included: "pro" },
  { name: "Context-aware AI responses", included: "pro" },
  { name: "Priority support", included: "pro" },
  { name: "Custom AI model training", included: "enterprise" },
  { name: "Unlimited rooms", included: "enterprise" },
  ...
  { name: "Code context integration", included: "all" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-figtree text-lg text-muted-foreground max-w-2xl mx-auto">
            Get started with DevRoom's collaborative coding platform. All plans
            include AI-powered bug resolution.
          </p>
        </div>

        {/* Billing Toggle */}
        <div className="flex justify-center mb-12">
          <div className="inline-flex items-center gap-2 bg-secondary rounded-md p-1">
            <button
              type="button"
              onClick={() => setIsYearly(false)}
              className={cn(
                "px-6 py-2 rounded-md font-figtree text-lg transition-all",
                !isYearly
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {plans.map((plan) => (
            <button
              ...
              className={cn(
                "relative p-8 rounded-md text-left transition-all border-2",
            ...
            >
              {plan.popular && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#156d95] text-white px-4 py-1 rounded-md text-sm font-figtree">
                  Most Popular
                </span>
              )}
              <div className="mb-6">
              ...
              <div
                className={cn(
                  "w-full py-3 px-6 rounded-md font-figtree text-lg transition-all text-center",
                  selectedPlan === plan.level
                    ...
                    {plans.map((plan) => (
                      ...
                      >
                        {shouldShowCheck(feature.included, plan.level) ? (
                          <div className="w-6 h-6 rounded-md bg-[#156d95] flex items-center justify-center">
        ...
        <div className="mt-12 text-center">
          <button className="bg-[#156d95] text-white px-[18px] py-[15px] rounded-md font-figtree text-lg hover:rounded-md transition-all">
