...
export const BankingScaleHero = () => {
  ...
  // @return
  return (
    <div className="w-full overflow-hidden bg-white dark:bg-[#1e1e1e]">
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Your AI pair programmer is always on call{" "}
              <span
              ...
              >
                — collaborate in real-time rooms with instant bug fixes.
              </span>
            </h2>

            <p
              className="text-lg leading-6 text-[#111A4A] dark:text-gray-300 opacity-60 mt-0 mb-6"
              style={{
                fontFamily: "var(--font-figtree), Figtree",
              }}
            >
              Create a room, share the link, and get instant AI assistance that
              understands your code context and resolves bugs in seconds.
            </p>

            <button className="relative inline-flex justify-center items-center leading-4 text-center cursor-pointer whitespace-nowrap outline-none font-medium h-9 text-[#232730] bg-white/50 backdrop-blur-sm shadow-[0_1px_1px_0_rgba(255,255,255,0),0_0_0_1px_rgba(87,90,100,0.12)] transition-all duration-200 ease-in-out rounded-md px-4 mt-5 text-sm group hover:shadow-[0_1px_2px_0_rgba(0,0,0,0.05),0_0_0_1px_rgba(87,90,100,0.18)]">
